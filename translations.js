const translations = {
    en: {
        ...
        aarti_selected: (aarti) => `🙏 *${aarti} Selected*\n\nPlease select your preferred date from the menu below, or type your preferred date in DD/MM/YYYY format (for any date in the next 30 days):`,
        btn_select_date: 'Select Date',
        invalid_date: '⚠️ Invalid date format. Please select from the menu or enter a valid date in DD/MM/YYYY format.',
        invalid_date_range: (minDate, maxDate) => `⚠️ You can only book for dates in the next 30 days. Please select from the menu or type a date between ${minDate} and ${maxDate}.`,
        ...
        ask_id_type: (index) => `Devotee ${index} Verification: Please select your document type:`,
        btn_aadhaar: 'Aadhaar Card',
        btn_passport: 'Passport',
        ask_passport_image: 'Please send a clear photo of the main page of your Passport.',
        verifying_passport: 'Verifying passport details. Please wait...',
        passport_verified: (name) => `Passport Verified: ${name}`,
        passport_failed: 'Passport verification failed. Please send a clearer photo of the passport main page.',
        invalid_passport_image: 'Please attach and send a valid passport image file.',
    ...
    hi: {
        ...
        aarti_selected: (aarti) => `🙏 *${aarti} चयनित*\n\nकृपया नीचे दिए गए मेनू से अपनी पसंदीदा तिथि चुनें, या अपनी पसंदीदा तिथि को DD/MM/YYYY प्रारूप में टाइप करें (अगले 30 दिनों में किसी भी तिथि के लिए):`,
        btn_select_date: 'तिथि चुनें',
        invalid_date: '⚠️ अमान्य तिथि प्रारूप। कृपया मेनू से चुनें या DD/MM/YYYY प्रारूप में एक वैध तिथि दर्ज करें।',
        invalid_date_range: (minDate, maxDate) => `⚠️ आप केवल अगले 30 दिनों के लिए ही बुकिंग कर सकते हैं। कृपया मेनू से चुनें या ${minDate} और ${maxDate} के बीच की तिथि टाइप करें।`,
        ...
        ask_id_type: (index) => `भक्त ${index} सत्यापन: कृपया दस्तावेज़ प्रकार चुनें:`,
        btn_aadhaar: 'आधार कार्ड',
        btn_passport: 'पासपोर्ट',
        ask_passport_image: 'कृपया अपने पासपोर्ट के मुख्य पृष्ठ की एक स्पष्ट तस्वीर भेजें।',
        verifying_passport: 'पासपोर्ट का सत्यापन किया जा रहा है। कृपया प्रतीक्षा करें...',
        passport_verified: (name) => `पासपोर्ट सत्यापित: ${name}`,
        passport_failed: 'पासपोर्ट सत्यापन विफल। कृपया पासपोर्ट की अधिक स्पष्ट तस्वीर भेजें।',
        invalid_passport_image: 'कृपया एक वैध पासपोर्ट छवि फ़ाइल भेजें।',
