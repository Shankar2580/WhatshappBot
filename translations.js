const translations = {
    en: {
        ...
        ask_guest_name: (index) => `👤 *Devotee #${index} Details*\n\nPlease enter the exact Full Name as it appears on their Aadhaar Card.`,
        ask_name: '👤 *Primary Devotee Details*\n\nPlease enter your exact Full Name as it appears on your Aadhaar Card.',
        invalid_name: '⚠️ Please enter a valid full name (minimum 2 characters).',
        ask_aadhaar: (name) => `✅ *Name Recorded:* ${name}\n\nFor mandatory security verification, please enter your 12-digit Aadhaar Number.`,
        ...
        ask_otp: '📩 *OTP Sent*\n\nA 6-digit OTP has been sent to your Aadhaar-linked mobile number. Please enter it below to complete verification:',
        ...
        aadhaar_verified: (name) => `✅ *Aadhaar Verified Successfully*\n\nWelcome, *${name}*. Your identity has been securely authenticated.`,
        ask_photo: '📸 *Live Photo Capture*\n\nAs a final security step, please capture and send a clear, live selfie of yourself or your group using the camera attachment.',
        ...
        booking_success: '🔱 *Jai Shri Mahakal!* 🔱\n\nYour booking has been *officially confirmed*. We are deeply honored to facilitate your divine journey to the Shri Mahakaleshwar Temple, Ujjain.\n\nMay Lord Mahakal shower you with infinite grace, remove all obstacles from your path, and bless your life with profound peace and prosperity. 🙏',
    ...
    hi: {
        ...
        ask_guest_name: (index) => `👤 *भक्त #${index} का विवरण*\n\nकृपया पूरा नाम ठीक वैसे ही दर्ज करें जैसा कि उनके आधार कार्ड पर अंकित है।`,
        ask_name: '👤 *मुख्य भक्त का विवरण*\n\nकृपया अपना पूरा नाम ठीक वैसे ही दर्ज करें जैसा कि आपके आधार कार्ड पर अंकित है।',
        invalid_name: '⚠️ कृपया एक वैध पूरा नाम दर्ज करें (न्यूनतम 2 अक्षर)।',
        ask_aadhaar: (name) => `✅ *नाम दर्ज किया गया:* ${name}\n\nअनिवार्य सुरक्षा सत्यापन के लिए, कृपया अपना 12 अंकों का आधार नंबर दर्ज करें।`,
        ...
        ask_otp: '📩 *OTP भेजा गया*\n\nआपके आधार-लिंक्ड मोबाइल नंबर पर 6 अंकों का OTP भेज दिया गया है। सत्यापन पूरा करने के लिए कृपया इसे नीचे दर्ज करें:',
        ...
        aadhaar_verified: (name) => `✅ *आधार सफलतापूर्वक सत्यापित*\n\nस्वागत है, *${name}*। आपकी पहचान सुरक्षित रूप से प्रमाणित कर दी गई है।`,
        ask_photo: '📸 *लाइव फोटो कैप्चर*\n\nअंतिम सुरक्षा चरण के रूप में, कृपया कैमरा अटैचमेंट का उपयोग करके अपनी या अपने समूह की एक स्पष्ट, लाइव सेल्फी खींचकर भेजें।',
        ...
        booking_success: '🔱 *जय श्री महाकाल!* 🔱\n\nआपकी बुकिंग *आधिकारिक रूप से पुष्ट* कर दी गई है। श्री महाकालेश्वर मंदिर, उज्जैन की आपकी दिव्य यात्रा को सुविधाजनक बनाने में हमें अत्यंत गौरव का अनुभव हो रहा है।\n\nभगवान महाकाल आप पर असीम कृपा बरसाएं, आपके मार्ग की सभी बाधाओं को दूर करें, और आपके जीवन को गहन शांति और समृद्धि से भर दें। 🙏',
