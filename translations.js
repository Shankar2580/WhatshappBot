const translations = {
    en: {
        ...
        ask_num_people: 'How many people will be attending? (Please enter a number between 1 and 4)',
        invalid_num_people: 'Invalid number. Please enter a number between 1 and 4.',
        ask_guest_name: (index) => `Great! Please type the Full Name (as per Aadhaar) for Person #${index}.`,
        ...
        ask_otp: 'Please enter the 6-digit OTP sent to your Aadhaar-linked mobile number.',
        invalid_otp: 'Invalid OTP or verification failed. Please try again.',
        aadhaar_failed: 'Failed to verify Aadhaar. Please ensure the number is correct and try again.',
        ...
        confirm_booking: (aarti, date, slot, people, namesStr) => `*Booking Summary*\n\n🕉️ Aarti: ${aarti}\n📅 Date: ${date}\n⏰ Slot: ${slot}\n👥 People: ${people}\n👤 Names: ${namesStr}\n\nDo you want to confirm this booking?`,
        btn_yes: 'Yes, Confirm',
        btn_no: 'No, Cancel',
    ...
    hi: {
        ...
        ask_num_people: 'कितने लोग उपस्थित होंगे? (कृपया 1 से 4 के बीच की संख्या दर्ज करें)',
        invalid_num_people: 'अमान्य संख्या। कृपया 1 से 4 के बीच की संख्या दर्ज करें।',
        ask_guest_name: (index) => `बहुत बढ़िया! कृपया व्यक्ति #${index} का पूरा नाम (आधार के अनुसार) टाइप करें।`,
        ...
        ask_otp: 'कृपया आपके आधार से जुड़े मोबाइल नंबर पर भेजा गया 6 अंकों का OTP दर्ज करें।',
        invalid_otp: 'अमान्य OTP या सत्यापन विफल। कृपया पुनः प्रयास करें।',
        aadhaar_failed: 'आधार सत्यापित करने में विफल। कृपया सुनिश्चित करें कि नंबर सही है और पुनः प्रयास करें।',
        ...
        confirm_booking: (aarti, date, slot, people, namesStr) => `*बुकिंग सारांश*\n\n🕉️ आरती: ${aarti}\n📅 तारीख: ${date}\n⏰ स्लॉट: ${slot}\n👥 लोग: ${people}\n👤 नाम: ${namesStr}\n\nक्या आप इस बुकिंग की पुष्टि करना चाहते हैं?`,
