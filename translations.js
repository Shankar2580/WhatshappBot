const translations = {
    en: {
        ...
        invalid_name: '⚠️ Please ente        ask_aadhaar: (index) => `👤 *Devotee ${index} Security Verification*\n\nFor mandatory security authentication, please enter their 12-digit Aadhaar Number.`,
    ...
    hi: {
        ...
        invalid_name: '⚠️ कृपया एक वैध प्रविष्टि दर्ज करें।',
        ...
        cancelled: '🚫 *प्रक्रिया समाप्त*\n\nबुकिंग प्रक्रिया रद्द कर दी गई है। फिर से शुरू करने के लिए "book" भेजें।'   generating_otp: '🔐 *सुरक्षित सत्यापन*\n\nसुरक्षित आधार सत्यापन आरंभ किया जा रहा है। कृपया प्रतीक्षा करें, हम आपका OTP जनरेट कर रहे हैं... 📲',
