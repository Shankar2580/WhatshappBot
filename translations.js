const translations = {
    en: {
        ...
        invalid_name: '⚠️ Please enter a valid full name using only letters (no numbers).',
        ...
        booking_success: '🔱 Har Har Mahadev!\nYour booking is now officially confirmed. Thank you for placing your trust in the divine blessings of Mahakaleshwar Temple, Ujjain. May Lord Mahakal remove every obstacle from your path and fill your life with happiness and strength. 🙏',
    ...
    hi: {
        ...
        invalid_name: '⚠️ कृपया केवल अक्षरों का उपयोग करके एक वैध पूरा नाम दर्ज करें (कोई संख्या नहीं)।',
        ...
        ask_photo: '📸 *चेहरा सत्यापन (Facial Verification) सेटअप*\n\nमंदिर के द्वार पर निर्बाध और संपर्क रहित प्रवेश के लिए, कृपया मुख्य भक्त की एक स्पष्ट, एकल (solo) सेल्फी खींचकर भेजें। प्रवेश द्वार पर यही आपकी पहचान होगी।',
        ...
        booking_success: '🔱 हर हर महादेव!\nआपकी बुकिंग अब आधिकारिक तौर पर पुष्ट हो गई है। उज्जैन के महाकालेश्वर मंदिर के दिव्य आशीर्वाद में अपना विश्वास रखने के लिए धन्यवाद। भगवान महाकाल आपके मार्ग से हर बाधा को दूर करें और आपके जीवन को खुशी और शक्ति से भर दें। 🙏',
